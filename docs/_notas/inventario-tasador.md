...
| `estado-procesando.tsx` (224 l., sirve Pantallas 4 y 6) | **P6-TAS** (lectura) · **P8-TAS** (cálculo) | Polling real contra `GET /api/tasaciones/[id]/estado`. "Continuar" bloqueado hasta "Datos listos" (CI-013). Literales de T-C. |
