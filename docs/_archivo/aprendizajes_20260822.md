# Aprendizajes archivados — bitácora 06-ago → 21-ago-2026

> **Archivado el 22-ago-2026.** Tercer archivado del proyecto, y el primero que se
> ejecuta como tanda propia según `CLAUDE.md` §«Archivado de la bitácora».
>
> **Qué hay acá:** 34 entradas de bitácora, del 06-ago-2026 al 21-ago-2026, en su
> orden original. Cubren el cierre de Tanda 3, la reestructura del path Dropbox
> (v1.9.6), el motor de SLA (Tandas A a E de §9.6), el sync documental contra la
> spec v1.9.8/v1.9.9 y el arranque de IF-03 (P2-TAS a P4-TAS).
>
> **Qué NO hay acá:** ninguna regla operativa. Las **RO-01 … RO-40** siguen íntegras
> en `docs/aprendizajes.md`, que es donde se consultan. Este archivo guarda el
> *relato* de los incidentes, no las reglas que destilaron — si buscás qué hacer,
> el archivo vivo manda; si buscás por qué, mirá acá.
>
> **Continuidad:** el archivo vivo conserva desde el **22-ago-2026** en adelante.
> Los dos archivados anteriores son `aprendizajes_20260714.md` (`E-001`…`E-017`) y
> `aprendizajes_20260807.md` (`E-018`…`E-096` y bitácora 24-jul → 06-ago-2026).
