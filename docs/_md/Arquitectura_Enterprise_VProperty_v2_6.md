...
+-----------------------------------------------------------------------+
  ...
  **Versión**           2.6 --- Arquitectura Enterprise Configurable
                        (alineada a Especificacion v1.4 · Julio 2026)
...
(usado en el diálogo de reasignación de tasador de IF-02). Estas piezas
...
## Recorrido paso a paso
  ...
  **6**    Asignar tasador Orquestación     Airtable Script AT02 lee M_Tasadores
                                            filtrando por zona y disponibilidad,
                                            selecciona al de menor carga y
                                            actualiza TX_Solicitudes. No
                                            interviene Make.
