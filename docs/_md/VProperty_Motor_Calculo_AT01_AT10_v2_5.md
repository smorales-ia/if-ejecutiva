...
pública en Railway) o IF-02 (interno, consola Next.js de la ejecutiva)
crea una nueva solicitud. En el estado creada se ejecutan en paralelo
AT01 (motor de reglas) y AT02 (asignación de tasador). El tasador
