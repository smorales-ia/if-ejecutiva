...
>
> **Precedencia.** Ante contradicción con `docs/_md/VProperty_Especificacion_Proyecto_v1_9_9.md`
...
4. `docs/_md/VProperty_Especificacion_Proyecto_v1_9_9.md` — **§2 completa** (§2.1 a §2.16). Es la
