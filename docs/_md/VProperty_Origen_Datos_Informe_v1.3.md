...
*Inventario completo de campos: ¿quién los entrega y cómo?*
  ...
  **Versión**        v1.3 · 07-sep-2026 · P13-TAS-ESCRITURA · §2.1: los
                     datos de permiso de edificación y recepción final se
                     ruteaban a TX_DatosTasacion; se corrigen a
                     TX_DocumentosLegales
                     (permiso_edificacion_numero/_fecha,
                     recepcion_final_numero/_fecha), que es la tabla que
                     el esquema y la UF del Tasador (Sección F) usan
                     realmente. Se nombra la «Escritura de Compraventa
                     Original» como fuente documental de esos cuatro
                     atributos (cláusulas 2ª/3ª), catalogados en
                     D_TipoDocumentoAtributo bajo el doc
                     escritura_compraventa (recX5FJFzAzXTXpzF). Sucede a
                     v1.2 (07-sep-2026), que queda en su sitio como
                     versión anterior.
  -----------------------------------------------------------------------
...
## Notas libres del tasador
  ...
  **Campo**                          **Destino**
  ...
  (párrafo bajo el cuadro de         schema de la muestra (columnas
  comparables)                       crudas de la foto), sin factores de
                                     homogeneización (A-44 · R-COMP-1)
...
**promedios simples de la muestra de comparables** (sin homogeneización —
el cuadro fotografiado no trae factores · A-44 · R-COMP-1), la **vida
útil remanente**, los **datos de rentabilidad**
...
## 4.1 · Datos provistos por el DAG de fórmulas (Motor AT03 · TX_Calculos)
  ...
  **Campo del informe**        **Paso DAG**  **Fórmula que lo produce**
  ...
  UF/m² promedio de la muestra Paso 1        mean simple de la muestra
  (4.172 / 4.166 / 1.593 /                   (sin homogeneización · A-44 ·
  1.269 / 1.171 / 21.440)                    R-COMP-1)
