...
| **Propósito** | Consolidación con respuestas del cliente (Héctor). Base para incorporación a la especificación oficial. **Ya incorporado**: el contenido de esta versión está vertido en `VProperty_Especificacion_Proyecto_v1_9_16.md` §5.2, que es la fuente normativa; este documento queda como insumo trazable. |
