...
>
> **Precedencia.** Ante cualquier contradicción con `docs/_md/VProperty_Especificacion_Proyecto_v1_9_8.md` u otros docs, mandan las **Reglas A, B, C** de este archivo (§0.3): son la fuente de verdad de la UI implementada. *(La ruta canónica es `v1_9_8`; el nombre de archivo de este plan conserva `v1_9` por compatibilidad con §0.1 — no renombrar.)*
...
La spec v1.9.8 §5.2 declara **dos relojes que conviven y no se sustituyen**: el **plazo
...
- **`docs/_md/VProperty_Especificacion_Proyecto_v1_9_8.md`** — **no requiere cambios**: es la
