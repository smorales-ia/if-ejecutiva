> **[SUPERSEDED]** Este documento fue reemplazado por `VProperty_Especificacion_Proyecto_v1_9_4.md` el 25-jul-2026.
>
...
> Aplica las cinco correcciones internas pendientes de la tabla §2.14 (§1.3.2/§1.3.3, §1.4/RN-59, §4.2.1, §6.2 AT03, cita Origen de Datos v1.1).
>
