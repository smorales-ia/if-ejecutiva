...
1. Lee `docs/diseno.md`, `docs/construccion.md` y `docs/schema-airtable.md` al inicio de la sesión.
   La fuente normativa de requisitos es `docs/_md/VProperty_Especificacion_Proyecto_v1_9_16.md`.
...
│  ├─ VProperty_Especificacion_Proyecto_v1_9_16.md   ← FUENTE NORMATIVA
...
`docs/_md/VProperty_Especificacion_Proyecto_v1_9_16.md`.
...
- **Especificación (normativa)**: `docs/_md/VProperty_Especificacion_Proyecto_v1_9_16.md`
